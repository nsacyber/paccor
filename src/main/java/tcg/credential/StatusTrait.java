...
public class StatusTrait extends Trait<AttributeStatus, StatusTrait> {
    ...
    public static StatusTrait getInstance(Object obj) {
        return Trait.getInstance(obj, StatusTrait.class, StatusTrait::fromASN1Sequence, StatusTrait::fromJsonNode);
    }
     ...
     * @return StatusTrait
     */
    public static StatusTrait fromJsonNode(JsonNode node) {
        return StatusTrait.builder()
                .traitType(StatusTrait.class)
                .deserializeTraitDescriptors(node)
                .traitValue(node, AttributeStatus.class)
                .build();
    }
