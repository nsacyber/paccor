...
public class TCGRelevantCredentials extends ASN1Object {
	...
	public static TCGRelevantCredentials getInstance(Object obj) {
		...
		if (obj instanceof ASN1Sequence seq) {
			return TCGRelevantCredentials.fromASN1Sequence(seq);
		}
	 ...
	 * @return TCGRelevantCredentials
	 */
	public static TCGRelevantCredentials fromASN1Sequence(@NonNull ASN1Sequence seq) {
