...
public class PublicKeyTrait extends Trait<SubjectPublicKeyInfo, PublicKeyTrait> {
    ...
    public static PublicKeyTrait getInstance(Object obj) {
        return Trait.getInstance(obj, PublicKeyTrait.class, PublicKeyTrait::fromASN1Sequence, PublicKeyTrait::fromJsonNode);
    }
     ...
     * @return PublicKeyTrait
     */
    public static PublicKeyTrait fromJsonNode(JsonNode node) {
        return PublicKeyTrait.builder()
                .traitType(PublicKeyTrait.class)
                .deserializeTraitDescriptors(node)
                .traitValue(node, SubjectPublicKeyInfo.class)
                .build();
    }
