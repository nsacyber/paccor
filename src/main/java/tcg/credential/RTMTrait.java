...
public class RTMTrait extends Trait<RTMTypes, RTMTrait> {
    ...
    public static RTMTrait getInstance(Object obj) {
        return Trait.getInstance(obj, RTMTrait.class, RTMTrait::fromASN1Sequence, RTMTrait::fromJsonNode);
    }
     ...
     * @return RTMTrait
     */
    public static RTMTrait fromJsonNode(JsonNode node) {
        return RTMTrait.builder()
                .traitType(RTMTrait.class)
                .deserializeTraitDescriptors(node)
                .traitValue(node, RTMTypes.class)
                .build();
    }
