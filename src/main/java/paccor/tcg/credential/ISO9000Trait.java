...
public class ISO9000Trait extends Trait<ISO9000Certification, ISO9000Trait> {
    ...
    public static ISO9000Trait getInstance(Object obj) {
        return Trait.getInstance(obj, ISO9000Trait.class, ISO9000Trait::fromASN1Sequence, ISO9000Trait::fromJsonNode);
    }
     ...
     * @return ISO9000Trait
     */
    public static ISO9000Trait fromJsonNode(JsonNode node) {
        return ISO9000Trait.builder()
                .traitType(ISO9000Trait.class)
                .deserializeTraitDescriptors(node)
                .traitValue(node, ISO9000Certification.class)
                .build();
    }
