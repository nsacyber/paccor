...
public class CertificateIdentifierTrait extends Trait<CertificateIdentifier, CertificateIdentifierTrait> {
    ...
    public static CertificateIdentifierTrait getInstance(Object obj) {
        return Trait.getInstance(obj, CertificateIdentifierTrait.class, CertificateIdentifierTrait::fromASN1Sequence, CertificateIdentifierTrait::fromJsonNode);
    }
     ...
     * @return CertificateIdentifierTrait
     */
    public static CertificateIdentifierTrait fromJsonNode(JsonNode node) {
        return CertificateIdentifierTrait.builder()
                .traitType(CertificateIdentifierTrait.class)
                .deserializeTraitDescriptors(node)
                .traitValue(node, CertificateIdentifier.class)
                .build();
    }
