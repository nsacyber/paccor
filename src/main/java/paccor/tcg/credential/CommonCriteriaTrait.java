...
public class CommonCriteriaTrait extends Trait<CommonCriteriaEvaluation, CommonCriteriaTrait> {
    ...
    public static CommonCriteriaTrait getInstance(Object obj) {
        return Trait.getInstance(obj, CommonCriteriaTrait.class, CommonCriteriaTrait::fromASN1Sequence, CommonCriteriaTrait::fromJsonNode);
    }
     ...
     * @return CommonCriteriaTrait
     */
    public static CommonCriteriaTrait fromJsonNode(JsonNode node) {
        return CommonCriteriaTrait.builder()
                .traitType(CommonCriteriaTrait.class)
                .deserializeTraitDescriptors(node)
                .traitValue(node, CommonCriteriaEvaluation.class)
                .build();
    }
