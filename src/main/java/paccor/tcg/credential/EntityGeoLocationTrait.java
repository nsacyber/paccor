...
public class EntityGeoLocationTrait extends Trait<EntityGeoLocation, EntityGeoLocationTrait> {
    ...
    public static EntityGeoLocationTrait getInstance(Object obj) {
        return Trait.getInstance(obj, EntityGeoLocationTrait.class, EntityGeoLocationTrait::fromASN1Sequence, EntityGeoLocationTrait::fromJsonNode);
    }
     ...
     * @return EntityGeoLocationTrait
     */
    public static EntityGeoLocationTrait fromJsonNode(JsonNode node) {
        return EntityGeoLocationTrait.builder()
                .traitType(EntityGeoLocationTrait.class)
                .deserializeTraitDescriptors(node)
                .traitValue(node, EntityGeoLocation.class)
                .build();
    }
