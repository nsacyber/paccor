...
public class ASN1UtilsTest {
    ...
    public void testToASN1EncodableVectorValidInput() throws IOException {
        ...
        TraitMap obj3 = TraitMapTest.sampleTraitMap1();
    ...
    public void testParseTaggedElementsNullInput() {
        Map<Integer, ASN1TaggedObject> result = ASN1Utils.parseTaggedElements(null);
    ...
    public void testParseTaggedElementsEmptySequence() {
        ...
        Map<Integer, ASN1TaggedObject> result = ASN1Utils.parseTaggedElements(emptySeq);
    ...
    public void testParseTaggedElementsTrait1() {
        ...
        Map<Integer, ASN1TaggedObject> result = ASN1Utils.parseTaggedElements((ASN1Sequence) fips.toASN1Primitive());

        Assertions.assertNotNull(result);
        Assertions.assertEquals(1, result.size());
        Assertions.assertTrue(result.containsKey(0));
        Assertions.assertEquals(fips.getDescription(), result.get(0).getBaseObject());
    }
    ...
    public void testParseTaggedElementsTbbSecurityAssertions1() {
        TBBSecurityAssertions tbb = TBBSecurityAssertions.builder()
                ...
                .build();
        Map<Integer, ASN1TaggedObject> result = ASN1Utils.parseTaggedElements((ASN1Sequence) tbb.toASN1Primitive());
