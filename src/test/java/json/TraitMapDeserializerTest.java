...
import tcg.credential.ASN1ObjectTrait;
import tcg.credential.AttributeStatus;
import tcg.credential.BooleanTrait;
import tcg.credential.CertificateIdentifierTrait;
import tcg.credential.CommonCriteriaTrait;
import tcg.credential.ComponentClassTrait;
import tcg.credential.ComponentIdentifierV11Trait;
import tcg.credential.CountryOfOriginTrait;
import tcg.credential.EntityGeoLocationTrait;
import tcg.credential.EnumWithIntegerValue;
import tcg.credential.FIPSLevelTrait;
import tcg.credential.IA5StringTrait;
import tcg.credential.ISO9000Trait;
import tcg.credential.NetworkMACTrait;
import tcg.credential.OIDTrait;
import tcg.credential.PEMCertStringTrait;
import tcg.credential.PENTrait;
import tcg.credential.PlatformFirmwareCapabilitiesTrait;
import tcg.credential.PlatformFirmwareSignatureVerificationTrait;
import tcg.credential.PlatformFirmwareUpdateComplianceTrait;
import tcg.credential.PlatformHardwareCapabilitiesTrait;
import tcg.credential.PublicKeyTrait;
import tcg.credential.RTMTrait;
import tcg.credential.RTMTypes;
import tcg.credential.StatusTrait;
import tcg.credential.Trait;
import tcg.credential.TraitId;
import tcg.credential.TraitMap;
import tcg.credential.URITrait;
