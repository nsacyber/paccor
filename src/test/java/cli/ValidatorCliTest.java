...
public class ValidatorCliTest {
    ...
    public void removeOldOutFiles() throws Exception {
        String[] filenames = new String[]{SigningCliTest.OUT_FILE, SigningCliTest.OUT_PKCS1_FILE, SigningCliTest.OUT_FILE_LARGE_2187, SigningCliTest.OUT_FILE_MEDIUM_2187, SigningCliTest.OUT_FILE_FLAWED_2187};
