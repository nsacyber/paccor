...
//        + "}";
        ...
        Assertions.assertEquals(ComponentIdentifierV2Factory.ComponentAddressType.ETHERNETMAC.getOid(), addressArray[0].getAddressType());
        Assertions.assertEquals(ethernetMacNormalized, addressArray[0].getAddressValue().getString());
        Assertions.assertEquals(ComponentIdentifierV2Factory.ComponentAddressType.WLANMAC.getOid(), addressArray[1].getAddressType());
        Assertions.assertEquals(wlanMacNormalized, addressArray[1].getAddressValue().getString());
        Assertions.assertEquals(ComponentIdentifierV2Factory.ComponentAddressType.BLUETOOTHMAC.getOid(), addressArray[2].getAddressType());
        Assertions.assertEquals(bluetoothMacNormalized, addressArray[2].getAddressValue().getString());
        Assertions.assertEquals(ComponentIdentifierV2Factory.ComponentAddressType.ETHERNETMAC.getOid(), addressArray[3].getAddressType());
        ...
        Assertions.assertNotNull(component.getComponentPlatformCert().getAttributeCertIdentifier());
        Assertions.assertNotNull(component.getComponentPlatformCert().getGenericCertIdentifier());
        Assertions.assertEquals(attributeCertHashAlg, component.getComponentPlatformCert().getAttributeCertIdentifier().getHashAlgorithm().getAlgorithm().getId());
        Assertions.assertEquals(attributeCertHash, Base64.toBase64String(component.getComponentPlatformCert().getAttributeCertIdentifier().getHashOverSignatureValue().getOctets()));
        ...
        Assertions.assertEquals(new AttributeStatus(status), component.getStatus());
    }
}
