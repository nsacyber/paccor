...
public class StorageTests {
    public static readonly string RegistryA21AtaComponentSample1Page3Base64 = "";
    ...
    public void TestAtaFormFactor() {
        ...
        Assert.That(StorageHardwareManifestPlugin.ATA_FormFactor(capsData.FormFactor, true), Is.EqualTo(RegistryA21AtaComponentSample1FormFactor));
    }
    ...
    public void TestAtaUniqueId() {
        ...
        Assert.Multiple(() => {
            Assert.That(StorageHardwareManifestPlugin.ATA_UNIQUEID(capsData.WWN, true), Is.EqualTo(RegistryA21AtaComponentSample1UniqueId));
            Assert.That(StorageHardwareManifestPlugin.ATA_UNIQUEID(capsData.WWN[1..2], true), Is.Empty);
        });
    }
    ...
    public void TestAtaAoi() {
        ...
        Assert.Multiple(() => {
            Assert.That(StorageHardwareManifestPlugin.ATA_AOI(capsData.WWN, true), Is.EqualTo(RegistryA21AtaComponentSample1Aoi));
            Assert.That(StorageHardwareManifestPlugin.ATA_AOI(capsData.WWN[1..2], true), Is.Empty);
        });
    }
